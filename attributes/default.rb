...
default[:newrelic][:aws_cloudwatch][:install_path] = "/data/newrelic_plugins"
...
default[:newrelic][:mysql][:install_path] = "/data/newrelic_plugins"
...
default[:newrelic][:wikipedia_example_ruby][:install_path] = "/data/newrelic_plugins"
